    ...
    <div className="min-h-screen">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[80vh] px-6">
        ...
        >
          <motion.p
            ...
            className="text-[10px] uppercase tracking-[0.3em] text-purple-300/80 mb-4"
          >
            CBSE Class XII • Physical Education
          </motion.p>
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-purple-300 via-fuchsia-300 to-purple-400 bg-clip-text text-transparent mb-3">
            PhysEd Pro
          </h1>
          <p className="text-purple-300/90 text-sm max-w-md mx-auto font-light">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-xs uppercase tracking-[0.2em] text-purple-300/80 mb-6"
        >
          Download Papers
        </motion.h2>
                ...
                <div className="p-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-1.5 mt-2">
                      <span className="text-[9px] px-2 py-0.5 rounded-full bg-emerald-500/10 text-purple-300">
                        With Answers
                      </span>
                      <span className="text-[9px] px-2 py-0.5 rounded-full bg-purple-500/10 text-purple-300">
                        Marking Scheme
                      </span>
                    </div>
                  </div>
              ...
              >
                <div className="p-5">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {year === 2025 && (
                      <span className="text-[9px] uppercase tracking-wider px-2 py-1 rounded-full bg-fuchsia-500/20 text-white animate-pulse">
                        Latest
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    ...
                    <span className="text-[9px] px-2 py-0.5 rounded-full bg-blue-500/10 text-purple-300">
                      Marking Scheme
                    </span>
                  </div>
                </div>
              ...
              <Link key={chapter} href={`/chapters?chapter=${encodeURIComponent(chapter)}`}>
                <LiquidCard delay={i * 0.05} className="h-full">
                  <div className="p-4 flex items-center gap-3">
                    <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-gradient-to-br from-purple-500/15 to-fuchsia-500/10 flex items-center justify-center text-sm font-bold text-purple-300">
                      {i + 1}
                    </div>
